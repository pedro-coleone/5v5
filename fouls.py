    ...
    if mray == False:
        ...
        #TODO FOULS: Revisar as posições futuramente do goalKick
            ...
            if ref_data["quad"] == 1:
                ...
                entidade2 = Entity(x=45, y=115,a=135, index=2)
                entidade3 = Entity(x=45, y=150,a=0, index=3)
                entidade4 = Entity(x=165, y=90,a=0, index=4)
            elif ref_data["quad"] == 3:
                entidade0 = Entity(x=22, y=90,a=0, index=0)
                entidade1 = Entity(x=40, y=55,a=225, index=1)
                entidade2 = Entity(x=45, y=65,a=225, index=2)
    ...
    if mray == True:
        if ref_data["foul"] == 1:
            ...
            if ref_data["quad"] == 1:
                ...
                entidade1 = Entity(x=210, y=125,a=45, index=1)
                entidade2 = Entity(x=205, y=115,a=45, index=2)
                ...
                entidade2 = Entity(x=205, y=65,a=315, index=2)
